function doPost(e) {
  ...
  try {
    ...
    const data = {
      ...
      enquiry: params.get('enquiry_type') || "",
      productType: (params.get('enquiry_type') === 'product') ? params.get('product_service') : "",
      serviceType: (params.get('enquiry_type') === 'service') ? params.get('product_service') : "",
      page: "" // Page not sent by form, set to empty
    };
